...
from django.utils.html import format_html  # для обхода безопасности джанго
...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ['id', 'title', 'category_link', 'tag_links', 'publish_date', 'created_at']
    ...
    category_link.short_description = 'Категория'  # изменение название метода category_link
